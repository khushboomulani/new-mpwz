...
@Component({
  selector: 'app-subadmin-view-gallary',
  templateUrl: './subadmin-view-gallary.component.html',
  styleUrls: ['./subadmin-view-gallary.component.css']
})
export class SubadminViewGallaryComponent implements OnInit {
