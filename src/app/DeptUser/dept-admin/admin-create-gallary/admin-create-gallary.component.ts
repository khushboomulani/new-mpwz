...
@Component({
  selector: 'app-admin-create-gallary',
  templateUrl: './admin-create-gallary.component.html',
  styleUrls: ['./admin-create-gallary.component.css']
})
export class AdminCreateGallaryComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    if
      ...
      this.galleryForm = this.formBuilder.group({
        gallaryname: ['', [Validators.required, Validators.pattern('^[a-zA-Z0-9 ]*$')]],
        galldescription: ['', [Validators.required, Validators.pattern('^[a-zA-Z0-9 .]*$')]]
