...
export class FileUploadService {
  ...
  public url: string = environment.url + "web-site-gallary/upload-gallary-img";
  ...
  // public functions
  public addToQueue(data: any, gid, d22) {
  ...
  private _upload(queueObj: FileQueueObject) {
    ...
    form.append('doc1', queueObj.file, queueObj.file.name);
    form.append('galaryid', this.enc.encrypt(this.gid));
    form.append('webx', this.d2);
