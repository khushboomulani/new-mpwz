...
@Component({
  selector: 'app-public-notice-board',
  templateUrl: './public-notice-board.component.html',
  styleUrls: ['./public-notice-board.component.css']
})
export class PublicNoticeBoardComponent implements OnInit {
